...
export default class MassFilesDownload extends NavigationMixin(LightningElement) {
    ...
    showModalPopUp(recordId){

        popUpObj=window.open(window.location.origin + '/sfc/servlet.shepherd/document/download/' + recordId,"ModalPopUp","width=400," + "height=300");
